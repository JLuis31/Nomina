      ...
      <div className="register-content">
        <div className="register-left">
          <div className="brand-section">
            ...
            <h1 className="brand-title">Payroll Management System</h1>
            <p className="brand-subtitle">
              Join us today and start managing your business efficiently
            </p>
          </div>
          ...
          <div className="features-list">
            <div className="feature-item">
              ...
              <span>Save time with automated calculations</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg
              ...
              <span>Secure and reliable cloud storage</span>
            </div>
          </div>
        </div>
        ...
        <div className="register-right">
          <div className="register-card">
            ...
            <div className="register-footer">
              <p>&copy; 2024 Payroll. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
